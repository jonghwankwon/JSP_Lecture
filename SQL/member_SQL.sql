...
CREATE TABLE IF NOT EXISTS `address_book` (
  ...
  `gender` varchar(2) NOT NULL DEFAULT '남',
  `tel` varchar(14) DEFAULT NULL,
  `address` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.address_book:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `address_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `address_book` ENABLE KEYS */;

-- 테이블 world.bbs 구조 내보내기
CREATE TABLE IF NOT EXISTS `bbs` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_bbs_member` (`memberId`),
  CONSTRAINT `FK_bbs_member` FOREIGN KEY (`memberId`) REFERENCES `member` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.bbs:~6 rows (대략적) 내보내기
/*!40000 ALTER TABLE `bbs` DISABLE KEYS */;
INSERT INTO `bbs` (`id`, `memberId`, `title`, `date`, `content`) VALUES
	(1, 100001, '글쓰기 테스트', '2019-04-23 11:09:22', '글쓰기 테스트입니다.'),
	(2, 100001, '글쓰기 테스트', '2019-04-23 11:09:58', '글쓰기 테스트글쓰기 테스트'),
	(3, 100001, '글쓰기 테스트', '2019-04-23 11:10:39', '글쓰기 테스트글쓰기 테스트글쓰기 테스트'),
	(4, 100001, '123', '2019-04-23 16:54:47', '123'),
	(5, 100001, 'Test', '2019-04-23 17:03:48', '테스트입니다'),
	(6, 100001, 'test', '2019-04-23 17:19:24', '테스트입니다!');
...
-- 테이블 데이터 world.city:~4,084 rows (대략적) 내보내기
...
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	...
	(4080, 'Gimpo', 'KOR', 'Kyonggi', 200001),
	(4081, 'Hwasong', 'KOR', 'Kyonggi', 312345),
	(4083, 'Pochon', 'KOR', 'Kyonggi', 156789),
	(4084, 'Osan', 'KOR', 'Kyonggi', 201234),
	(4085, 'Pochon', 'KOR', 'Kyonggi', 156789);
/*!40000 ALTER TABLE `city` ENABLE KEYS */;

-- 테이블 world.citycopy 구조 내보내기
CREATE TABLE IF NOT EXISTS `citycopy` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` char(35) NOT NULL DEFAULT '',
  `CountryCode` char(3) NOT NULL DEFAULT '',
  `District` char(20) NOT NULL DEFAULT '',
...
-- 테이블 데이터 world.citycopy:~4,081 rows (대략적) 내보내기
/*!40000 ALTER TABLE `citycopy` DISABLE KEYS */;
INSERT INTO `citycopy` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	(1, 'Kabul', 'AFG', 'Kabol', 1780000),
	(2, 'Qandahar', 'AFG', 'Qandahar', 237500),
	(3, 'Herat', 'AFG', 'Herat', 186800),
	(4, 'Mazar-e-Sharif', 'AFG', 'Balkh', 127800),
	...
	(4080, 'Gimpo', 'KOR', 'Kyonggi', 200001),
	(4081, 'Hwasong', 'KOR', 'Kyonggi', 312345);
/*!40000 ALTER TABLE `citycopy` ENABLE KEYS */;
...
-- 테이블 데이터 world.date_table:~5 rows (대략적) 내보내기
/*!40000 ALTER TABLE `date_table` DISABLE KEYS */;
INSERT INTO `date_table` (`id`, `datetime`) VALUES
	(101, '2017-08-28 12:42:23'),
	(102, '2017-02-15 10:22:24'),
	(103, '2017-12-09 14:41:45'),
	(104, '2018-07-06 20:15:18'),
	(105, '2019-04-02 09:10:31');
...
CREATE TABLE IF NOT EXISTS `eagles` (
  ...
  `high_school` char(50) DEFAULT NULL,
...
INSERT INTO `eagles` (`back_no`, `name`, `position`, `high_school`, `hand`, `birth`, `Salary`) VALUES
	(7, '송광민', '내야수', '공주고', '우투우타', '1983-06-24', 25000),
	(8, '정근우', '내야수', '부산고', '우투우타', '1982-10-02', 70000),
	(13, '최재훈', '포수', '덕수고', '우투우타', '1989-08-27', 12500),
	(15, '이용규', '외야수', '덕수정보산업고', '좌투좌타', '1985-08-26', 40000),
	(26, '지성준', '포수', '청주고', '우투우타', '1994-04-10', 5500),
	(31, '송창식', '투수', '세광고', '우투우타', '1985-03-25', 20000),
	(39, '김민하', '외야수', '경남고', '우투우타', '1989-02-25', 3900),
	(42, '김인환', '내야수', '화순고', '우투좌타', '1994-01-28', 3000),
	(52, '김태균', '내야수', '천안북일고', '우투우타', '1982-05-29', 150000),
	(99, '박재홍', '투수', '대전고', '우투우타', '1999-01-01', 2700);
/*!40000 ALTER TABLE `eagles` ENABLE KEYS */;

-- 테이블 world.girl_group 구조 내보내기
CREATE TABLE IF NOT EXISTS `girl_group` (
  `_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL,
  `debut` date NOT NULL,
  `hit_song_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.girl_group:~11 rows (대략적) 내보내기
/*!40000 ALTER TABLE `girl_group` DISABLE KEYS */;
INSERT INTO `girl_group` (`_id`, `name`, `debut`, `hit_song_id`) VALUES
	(1, '원더걸스', '2007-02-10', 101),
	(2, '소녀시대', '2007-08-02', 102),
	(3, '카라', '2009-07-30', 103),
...
-- 뷰 world.koreancity 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
CREATE TABLE `koreancity` (
	`id` INT(11) NOT NULL,
	`name` CHAR(35) NOT NULL COLLATE 'latin1_swedish_ci',
	`district` CHAR(20) NOT NULL COLLATE 'latin1_swedish_ci',
	`population` INT(11) NOT NULL
) ENGINE=MyISAM;

-- 뷰 world.largecity 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
CREATE TABLE `largecity` (
	`ID` INT(11) NOT NULL,
	`Name` CHAR(35) NOT NULL COLLATE 'latin1_swedish_ci',
	`CountryCode` CHAR(3) NOT NULL COLLATE 'latin1_swedish_ci',
	`District` CHAR(20) NOT NULL COLLATE 'latin1_swedish_ci',
	`Population` INT(11) NOT NULL
) ENGINE=MyISAM;
...
INSERT INTO `member` (`id`, `password`, `name`, `birthday`, `address`, `hashed`) VALUES
	(100001, '*', '김자바', '1998-07-12', '대전광역시 서구 월평동 55', '$2a$10$wi6XiHZhwMQMYJxOc//4Kughzv.a7evzYM.1f1c3EPN526Ynmirrq'),
	(100002, '*', '김이젠', '1995-06-03', '대전광역시 서구 관저동', '$2a$10$VwjfbQS5PQ9EHMedu7vy6.wgkWzxBN6zBHlZj0enp42Nbo2crty4a');
/*!40000 ALTER TABLE `member` ENABLE KEYS */;

-- 테이블 world.song 구조 내보내기
...
-- 테이블 데이터 world.song:~19 rows (대략적) 내보내기
/*!40000 ALTER TABLE `song` DISABLE KEYS */;
INSERT INTO `song` (`_id`, `title`, `lyrics`) VALUES
	...
	(117, '가시나', '왜 예쁜 날 두고 가시나 (날 두고 가시나)'),
	(118, '빨간 맛', '빠빠빨간 맛 궁금해 허니'),
	(123, '넌 이즈 뭔들', '나 지금 너 땜에 혼란스러 제발 누가 나 좀 말려줘');
/*!40000 ALTER TABLE `song` ENABLE KEYS */;

-- 테이블 world.student 구조 내보내기
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `s_tel` varchar(16) DEFAULT NULL,
  `hs_id` int(8) unsigned NOT NULL,
  PRIMARY KEY (`s_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1006 DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.student:~4 rows (대략적) 내보내기
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` (`s_id`, `s_name`, `dept_id`, `s_email`, `s_tel`, `hs_id`) VALUES
	(1001, '정근우', 602, 'kwchung@naver.com', '010-2345-1234', 50001),
	(1002, '이용규', 601, 'yklee@kakao.com', '010-2345-2345', 50002),
	(1004, '천사', 201, ' hoying@google.com', '010-3456-4567', 90001),
	(1005, '이태양', 603, 'sunlee@naver.com', '010-5678-5678', 50004);
/*!40000 ALTER TABLE `student` ENABLE KEYS */;

-- 테이블 world.tmp_table 구조 내보내기
CREATE TABLE IF NOT EXISTS `tmp_table` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.tmp_table:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `tmp_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `tmp_table` ENABLE KEYS */;

-- 테이블 world.wp_options 구조 내보내기
...
-- 테이블 데이터 world.wp_options:0 rows 내보내기
/*!40000 ALTER TABLE `wp_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_options` ENABLE KEYS */;

-- 뷰 world.koreancity 구조 내보내기
-- 임시 테이블을 제거하고 최종 VIEW 구조를 생성
DROP TABLE IF EXISTS `koreancity`;
CREATE ALGORITHM=UNDEFINED DEFINER=`javauser`@`localhost` SQL SECURITY DEFINER VIEW `koreancity` AS select `city`.`ID` AS `id`,`city`.`Name` AS `name`,`city`.`District` AS `district`,`city`.`Population` AS `population` from `city` where (`city`.`CountryCode` = 'kor') WITH CASCADED CHECK OPTION;

-- 뷰 world.largecity 구조 내보내기
-- 임시 테이블을 제거하고 최종 VIEW 구조를 생성
DROP TABLE IF EXISTS `largecity`;
CREATE ALGORITHM=UNDEFINED DEFINER=`javauser`@`localhost` SQL SECURITY DEFINER VIEW `largecity` AS select `city`.`ID` AS `ID`,`city`.`Name` AS `Name`,`city`.`CountryCode` AS `CountryCode`,`city`.`District` AS `District`,`city`.`Population` AS `Population` from `city` where (`city`.`Population` > 7000000) WITH CASCADED CHECK OPTION;
